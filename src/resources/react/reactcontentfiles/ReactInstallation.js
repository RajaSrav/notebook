...
import nodeInstall from '../images/nodeinstallation.png'
import noteNext from '../images/nodenext.png'
import nodeversion from '../images/nodeversions.png'
        ...
        return (
            <div className="installation introduction">
                ...
                {/* <h5>React Environment Setup</h5> */}
                 ...
                 <p><span>Download Install NodeJS and NPM </span> <a href="https://nodejs.org/en/download/"> Click here</a></p>
                 <img src={nodeJs} alt="installation"/>
                 <p>After the download is complete we will go to the downloads folder and run the installer.</p>
                 <img src={nodeInstall} alt="installation"/>
                 <p>The installer will show the below Setup image. Click Next.</p>
                 <img src={noteNext} alt="installation"/>
                 <p>The installer will show the below Setup image. Click next.</p>
                 ...
                 <img src={nodeversion} alt="Version npm node"/>
            </div>
        )
    }
}
